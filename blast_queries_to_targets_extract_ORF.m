function blast_queries_to_targets_extract_ORF(queryGenes,targetStrains)
...
%
% Last updated 20141113 by JW.
% Updated to return orientation of the hit

blastPath = 'blast-2.2.17-macosx/bin/blastall'; % BLAST executable (MacOSX)

queryPath = 'data/query_genes/';     % contains FASTA files of query genes
targetPath = 'data/target_genomes/'; % contains FASTA files of target genomes
...
for iquery = 1:length(queryGenes)
    ...
    [names_genomes_Liti,sequences_cells_Liti]=extract_Liti(queryGenes{iquery});
    ...
    [tot_changes,syn_changes,ns_changes]=compare_sequences_liti_BLAST(names_genomes,sequences_cells,names_genomes_Liti,sequences_cells_Liti,queryGenes{iquery});
