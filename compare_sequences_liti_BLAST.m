...
%load('output/LITI_results')
%load('output/BLAST_results_20150310')
...
% Get the haplotypes only for the ORF

%Only extract sequences for the strains in the study

%length(intersect(nm_all, strains_in_study_20150622))
