...
save(['../output_bioinformatics/PROT_output_bionformatics_' queryGene],'PROT_SNP_Structure','PROT_idx_identical_sequences','protein_table','All_names')
...
save(['../output_bioinformatics/DNA_output_bionformatics_PROMOTER_ORF' queryGene],'DNA_SNP_structure','DNA_idx_identical_sequences','sequence_table_DNA','All_names');

get_orf_promoter=0;
%haplotypes for the coding region
[DNA_SNP_structure,sequence_table_DNA]=SNP_finder_DNA(sequence_table,All_names,get_orf_promoter,queryGene,path_output_bionformatics);
DNA_idx_identical_sequences=determine_unique(DNA_SNP_structure, sequence_table_DNA, All_names);
save(['../output_bioinformatics/DNA_output_bionformatics_ONLY_ORF' queryGene],'DNA_SNP_structure','DNA_idx_identical_sequences','sequence_table_DNA','All_names');
